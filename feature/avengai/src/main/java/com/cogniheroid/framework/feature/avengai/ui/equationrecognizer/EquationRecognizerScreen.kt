...
fun EquationRecognizerAIScreen(onAddImage: () -> Unit) {
    ...
    val viewModel = viewModel<EquationRecognizerViewModel>(factory = AvengerAICore
        .equationRecognizerViewModelFactory)
    ...
    Scaffold(containerColor = MaterialTheme.colorScheme.background, topBar = {
        ...
        Surface(tonalElevation = 3.dp) {
            TopAppBar(modifier = Modifier.statusBarsPadding(), colors = colors, title = {
                Text(
                    text = stringResource(id = R.string.title_equation_recognizer), fontSize = 16.sp,
        ...
        Column(
            ...
            Text(
                ...
                text = stringResource(id = R.string.placeholder_choose_an_equation_image), fontSize = 16.sp,
                color = MaterialTheme.colorScheme.onSurface)
                    ...
                    Box(modifier = Modifier.size(20.dp).constrainAs(close) {
                        ...
                        Icon(
                            modifier = Modifier.clickable {
                                viewModel.performIntent(EquationRecognizerUIEvent.RemoveImage(equationRecognizerState
                                    .image))
            ...
            if(equationRecognizerState.image != null) {
                CustomButton(label = stringResource(id = R.string.placeholder_button_equation)) {
                    viewModel.performIntent(EquationRecognizerUIEvent.GenerateText(equationRecognizerState.image,
                        defaultErrorMessage))
                }
            }
                            ...
                            Icon(modifier = Modifier
                                ...
                                .clickable {
                                    ContentUtils.shareContent(
                                        context = context, data = equationRecognizerState.outputText)
                            ...
                            Icon(modifier = Modifier
                                ...
                                .clickable {
                                    ContentUtils.copyAndShowToast(
                                        context = context, result = equationRecognizerState.outputText)
