...
fun NutrientAIScreen(avengerAd : AvengerAd, onAddImage : () -> Unit, navigateBack : () -> Unit) {
    ...
    val nutrientUIState =
        viewModel.nutrientUIStateFlow.collectAsState(NutrientUIState.getDefault()).value
        ...
        AdUIContainer(modifier = Modifier
            ...
            Column(
                ...
                Text(
                    ...
                    text = stringResource(id = R.string.placeholder_choose_an_image),
                ...
                if(nutrientUIState.image != null) {
                    ConstraintLayout(
                        modifier = Modifier
                            .wrapContentSize()
                            .padding(end = 12.dp, top = Dimensions.padding24)) {
                            ...
                            Icon(
                                modifier = Modifier.clickable {
                                    viewModel.performIntent(
                                        NutrientUIEvent.RemoveImage(nutrientUIState.image))
                ...
                if(nutrientUIState.image != null) {
                    CustomButton(
                        label = stringResource(id = R.string.placeholder_button_nutrient)) {
                        viewModel.performIntent(
                            NutrientUIEvent.GenerateText(
                                nutrientUIState.image, defaultErrorMessage))
                    }
                }
