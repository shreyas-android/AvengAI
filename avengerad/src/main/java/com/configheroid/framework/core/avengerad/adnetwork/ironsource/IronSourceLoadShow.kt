package com.configheroid.framework.core.avengerad.adnetwork.ironsource

import android.app.Activity
import android.content.Context
import android.util.Log
import android.widget.Toast
import com.configheroid.framework.core.avengerad.adnetwork.ironsource.IronSource.APP_KEY
       ...
       /* IronSource.setLevelPlayRewardedVideoListener(object : LevelPlayRewardedVideoListener {
            ...
            override fun onAdShowFailed(error: IronSourceError, adInfo: AdInfo) {
                ...
                AdGalaxyAnalytics.logEvent(
                    ...
                    error.errorMessage.toBundle(com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.ERROR_MESSAGE)
                )
                Toast.makeText(
                    activity,
    ...
    fun loadInterstitialAd(activity: Activity, placementName: String, callback: (AdLifecycleState) -> Unit) {
        ...
        /*IronSource.setLevelPlayInterstitialListener(object : LevelPlayInterstitialListener {
            ...
            override fun onAdLoadFailed(error: IronSourceError) {
                AdGalaxyAnalytics.logEvent(
                    com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.IRON_SOURCE_INTERSTITIAL_AD_LOAD_FAILED,
                    error.errorMessage.toBundle(com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.ERROR_MESSAGE)
                )
                Log.d(
                    "CHECKIRONSOURCE",
            ...
            override fun onAdShowFailed(error: IronSourceError, adInfo: AdInfo) {
                AdGalaxyAnalytics.logEvent(
                    com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.IRON_SOURCE_INTERSTITIAL_AD_DISPLAY_FAILED,
                    error.errorMessage.toBundle(com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.ERROR_MESSAGE)
                )
                Log.d(
                    "CHECKIRONSOURCE",
        ...
        if (IronSource.isInterstitialReady()) {
            ...
            AdGalaxyAnalytics.logEvent(
                com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.IRON_SOURCE_INTERSTITIAL_AD_LOAD_FAILED,
                "FAILED".toBundle(com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.ERROR_MESSAGE))
            Toast.makeText(
                activity,
   ...
   /* fun getBannerAd(activity: Activity, placement: String): IronSourceBannerLayout {
        ...
        banner.levelPlayBannerListener = object : LevelPlayBannerListener {
            override fun onAdLoaded(p0: AdInfo?) {
                ...
                AdGalaxyAnalytics.logEvent(com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.IRON_SOURCE_BANNER_LOADED)
            }

            override fun onAdLoadFailed(p0: IronSourceError) {
                AdGalaxyAnalytics.logEvent(
                    com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.IRON_SOURCE_BANNER_LOAD_FAILED,
                    p0.errorMessage.toBundle(com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.ERROR_MESSAGE)
                )
                Log.d(
                    "CHECKIRONSOURCE",
