...
internal class ApplovinLoadShow {
    ...
    fun onShowInterstitialAd(interstitialAd: MaxInterstitialAd, callback: (AdLifecycleState) -> Unit) {
        interstitialAd.setListener(object : MaxAdListener {
            ...
            override fun onAdDisplayed(p0: MaxAd) {
                ...
                AdGalaxyAnalytics.logEvent(com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.APPLOVIN_INTERSTITIAL_AD_DISPLAYED)
            ...
            override fun onAdDisplayFailed(p0: MaxAd, p1: MaxError) {
                ...
                AdGalaxyAnalytics.logEvent(
                    com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.APPLOVIN_INTERSTITIAL_AD_DISPLAY_FAILED, p1
    ...
    fun onShowRewardAd(rewardedAd: MaxRewardedAd, callback: (AdLifecycleState) -> Unit) {
        ...
        rewardedAd.setListener(object : MaxRewardedAdListener {
            ...
            override fun onAdDisplayFailed(p0: MaxAd, p1: MaxError) {
                ...
                AdGalaxyAnalytics.logEvent(
                    com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.APPLOVIN_REWARD_AD_DISPLAY_FAILED,
                    p1.message.toBundle(AdGalaxyAnalytics.ERROR_MESSAGE)
                )
                callback(AdLifecycleState.FAILED)
            }
    ...
    fun getMRECView(activity: Activity, adUnitId: String): MaxAdView {
        ...
        adView.setListener(object : MaxAdViewAdListener {
            ...
            override fun onAdDisplayFailed(p0: MaxAd, p1: MaxError) {
                AdGalaxyAnalytics.logEvent(
                    com.configheroid.framework.core.avengerad.analytics.AdGalaxyAnalytics.APPLOVIN_MREC_DISPLAY_FAILED,
                    p1.message.toBundle(AdGalaxyAnalytics.ERROR_MESSAGE)
                )
            }
