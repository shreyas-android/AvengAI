...
class InMobiLoadShow {

    fun init(context: Context) {
        com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_INIT)
        ...
        InMobiSdk.init(context, InMobi.APP_ID, consentObject) {
            ...
            com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(
                com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_INIT_COMPLETE, it?.message?.toBundle(
    ...
    fun loadInterstitialAd(activity: Activity, adUnitId: Long, callback:(AdLifecycleState)->Unit) {
        com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_INTERSTITIAL_AD_LOAD)
        ...
        val interstitialAd = InMobiInterstitial(activity, adUnitId, object :
            ...
            override fun onAdDisplayFailed(p0: InMobiInterstitial) {
                com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(
                    com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_INTERSTITIAL_AD_DISPLAYED, "FAILED".toBundle(
                        com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.AD_TYPE))
            ...
            override fun onAdFetchFailed(p0: InMobiInterstitial, p1: InMobiAdRequestStatus) {
                com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(
                    com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_INTERSTITIAL_AD_LOADED, p1.message.toBundle(
                        com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.ERROR_MESSAGE))
            ...
            override fun onAdDisplayed(p0: InMobiInterstitial, p1: AdMetaInfo) {
                ...
                com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_INTERSTITIAL_AD_DISPLAYED)
            }

            override fun onAdLoadSucceeded(p0: InMobiInterstitial, p1: AdMetaInfo) {
                super.onAdLoadSucceeded(p0, p1)
                com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_INTERSTITIAL_AD_LOADED)
    ...
    fun loadRewardedAd(activity: Activity, adUnitId: Long, callback:(AdLifecycleState)->Unit) {
        com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_REWARD_AD_LOAD)
        ...
        val rewardedAd = InMobiInterstitial(activity, adUnitId, object :
            ...
            override fun onAdDisplayFailed(p0: InMobiInterstitial) {
                super.onAdDisplayFailed(p0)
                com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(
                    com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_REWARD_AD_DISPLAYED, "FAILED".toBundle(
                        com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.AD_TYPE))
            ...
            override fun onAdFetchFailed(p0: InMobiInterstitial, p1: InMobiAdRequestStatus) {
                super.onAdFetchFailed(p0, p1)
                com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(
                    com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_REWARD_AD_LOADED, p1.message.toBundle(
                        com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.ERROR_MESSAGE))
            ...
            override fun onAdDisplayed(p0: InMobiInterstitial, p1: AdMetaInfo) {
                super.onAdDisplayed(p0, p1)
                com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_REWARD_AD_DISPLAYED)
                Log.d("CHECKINMOBI","CHEKCING THE APP LOCIB = loadRewardedAd:: onAdDisplayed::$")
            }

            override fun onAdLoadSucceeded(p0: InMobiInterstitial, p1: AdMetaInfo) {
                super.onAdLoadSucceeded(p0, p1)
                com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_REWARD_AD_LOADED)
    ...
    fun getBannerView(activity: Activity, id: Long): InMobiBanner {
        com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_BANNER_LOAD)
        ...
        bannerAd.setListener(object : BannerAdEventListener() {
            override fun onAdFetchFailed(p0: InMobiBanner, p1: InMobiAdRequestStatus) {
                super.onAdFetchFailed(p0, p1)
                com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(
                    com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.IN_MOBI_BANNER_LOADED, p1.message.toBundle(
                        com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.ERROR_MESSAGE))
                Toast.makeText(
                    activity,
