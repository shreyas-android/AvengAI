...
class ChartBoostLoadShow {

    fun init(context: Context) {
        com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.CHART_BOOST_INIT)
        HeliumSdk.start(
            context,
            com.androidai.demo.avengerad.adnetwork.chartboost.ChartBoost.APP_ID,
            com.androidai.demo.avengerad.adnetwork.chartboost.ChartBoost.APP_SIGNATURE,
            null,
            object : HeliumSdk.HeliumSdkListener {
                override fun didInitialize(error: Error?) {
                    com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(
                        com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.CHART_BOOST_INIT_COMPLETE,
    ...
    private suspend fun getFullScreenAd(
        ...
        if (isReward) {
            com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.CHART_BOOST_REWARD_AD_LOAD)
        } else {
            com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.CHART_BOOST_INTERSTITIAL_AD_LOAD)
        }
    ...
    fun getBannerAd(context: Context, adUnitId: String): HeliumBannerAd {
        com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.logEvent(com.androidai.demo.avengerad.analytics.AdGalaxyAnalytics.CHART_BOOST_BANNER_LOAD)
