...
import com.cogniheroid.framework.feature.avengai.ui.equationrecognizer.EquationRecognizerAIScreen
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.collectLatest
import kotlinx.coroutines.launch

class AdGalaxyActivity : BaseActivity() {
    ...
    private fun checkPermission(callback:() -> Unit){
        ...
        if(ContextCompat.checkSelfPermission(this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            if(ActivityCompat.shouldShowRequestPermissionRationale(
                ...
                Toast.makeText(this, resources.getString(R.string
